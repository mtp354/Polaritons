...
class DispersionModel:
    ...
    def Q(self, k_si: float | np.ndarray, eta: float) -> complex | np.ndarray:
        ...
        """
        p    = self.p
        k_nat = np.asarray(k_si, dtype=float) * p.L_unit
        Q_nat = (
