...
conftest.py.  Physics checks work in natural units because that fixture
uses params_nat.
"""
import numpy as np
import pytest
...
class TestDispersionModelConstruction:
    ...
    def test_q_grid_si_scaling(self, simple_model, params_nat, q_grid_nat):
        """q_grid_si = q_grid_nat / L_unit."""
        expected = q_grid_nat / params_nat.L_unit
