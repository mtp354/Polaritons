...
class TestHopfieldCoefficients:
    ...
    def test_resonance_equal_mixing(self, simple_model, params_nat, eta_grid):
        """
...
class TestPolaritonInteractionStrengthBare:
    def test_positive(self, simple_model, params_nat, eta_grid):
    ...
    def test_bounded_by_g_ex(self, simple_model, params_nat):
        """g_bare <= g_ex / N_qw since |X_LP|^4 <= 1."""
        k_arr    = simple_model.q_grid_si[1:6]
        g_upper  = params_nat.g_ex / params_nat.N_qw
        g = polariton_interaction_strength(
    ...
    def test_resonance_value(self, simple_model, params_nat):
        """
        ...
        expected = params_nat.g_ex / (4.0 * params_nat.N_qw)
...
class TestChemicalPotential:
    def test_negative(self, simple_model, params_nat):
        ...
        mu = chemical_potential(
            ...
            L_terms=20, k_upper=50.0, n_k=500,
        )
